...
sudo wget -O /portainer/Files/AppData/Config/Caddy/Caddyfile https://github.com/pi-hosted/pi-hosted/blob/master/configs/Caddyfile || error "Failed to download Caddyfile file!"
